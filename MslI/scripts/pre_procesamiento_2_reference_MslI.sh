...
mkdir /home/jorge/POPULATIONS_GENOMICS/MslI/ipyrad/reference/params
cd    /home/jorge/POPULATIONS_GENOMICS/MslI/ipyrad/reference/params
...
do 
	...
	sed -i '/\[1] /c\/home/jorge/POPULATIONS_GENOMICS/MslI/ipyrad/reference/MslI_'$i'  	## [1] [project_dir] ' 	        	params-coco_$i.txt
	...
	sed -i '/\[6] /c\/home/jorge/POPULATIONS_GENOMICS/CoConut.genome.fa                 ## [6] [reference_sequence]: '      params-coco_$i.txt 
	...
	sed -i '/\[27] /c\reference                                                         ## [5] [assembly_method]: '			params-coco_$i.txt
...
do 
	...
	ipyrad -p /home/jorge/POPULATIONS_GENOMICS/MslI/ipyrad/reference/params/params-coco_$i.txt -r -f -s 12
	mkdir /home/jorge/POPULATIONS_GENOMICS/MslI/ipyrad/reference/fastqc/corrida_$i
	perl /home/jorge/FastQC/fastqc /home/jorge/POPULATIONS_GENOMICS/MslI/ipyrad/reference/MslI_$i/MslI_$[i]_fastqs/*.fastq.gz -o /home/jorge/POPULATIONS_GENOMICS/MslI/ipyrad/reference/fastqc/corrida_$i
