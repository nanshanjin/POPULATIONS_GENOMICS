...
mkdir /home/jorge/POPULATIONS_GENOMICS/PstI-MspI/ipyrad/
mkdir /home/jorge/POPULATIONS_GENOMICS/PstI-MspI/ipyrad/params
cd 	  /home/jorge/POPULATIONS_GENOMICS/PstI-MspI/ipyrad/params

ipyrad -n coco_PM

	sed -i '/\[1] /c\/home/jorge/POPULATIONS_GENOMICS/PstI-MspI/ipyrad/PM 		## [1] [project_dir] ' 	   			params-coco_PM.txt
	...
	sed -i '/\[27] /c\denovo                                                                ## [5] [assembly_method]: '			params-coco_PM.txt

	

ipyrad -p /home/jorge/POPULATIONS_GENOMICS/PstI-MspI/ipyrad/params/params-coco_PM.txt -r -f -s 12 # corro los primeros dos pasos correspondientes al preprocesamiento de los datos, este paso es comun a todos los analisis posteriores

mkdir /home/jorge/POPULATIONS_GENOMICS/PstI-MspI/ipyrad/fastqc/
perl /home/jorge/FastQC/fastqc /home/jorge/POPULATIONS_GENOMICS/PstI-MspI/ipyrad/PM/PstI-MspI_fastqs/*.fastq.gz -o /home/jorge/POPULATIONS_GENOMICS/PstI-MspI/ipyrad/fastqc/
